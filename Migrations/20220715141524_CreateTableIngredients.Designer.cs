...
namespace la_mia_pizzeria_model.Migrations
{
    ...
    [Migration("20220715141524_CreateTableIngredients")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("la_mia_pizzeria_model.Ingredienti", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IngredientiPizza", b =>
                {
                    b.HasOne("la_mia_pizzeria_model.Pizza", null)
                        .WithMany()
                        .HasForeignKey("IngredientiPIzzaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("la_mia_pizzeria_model.Ingredienti", null)
                        .WithMany()
